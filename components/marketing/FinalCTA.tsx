  ...
  return (
    <section className="pb-20">
      <div className="ha-container">
        <div className="overflow-hidden rounded-[var(--radius-lg)] border border-white/[0.1] bg-[linear-gradient(135deg,rgba(124,92,255,0.18),rgba(34,211,238,0.08),rgba(255,255,255,0.04))] p-8 sm:p-10">
