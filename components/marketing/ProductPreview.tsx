...
export function ProductPreview() {
  return (
    <section aria-label="Hakimi Auto product preview" className="ha-container pb-20">
      <div className="preview-float overflow-hidden rounded-[var(--radius-lg)] border border-white/[0.12] bg-[linear-gradient(180deg,rgba(255,255,255,0.1),rgba(255,255,255,0.04))] shadow-[0_30px_120px_-70px_rgba(34,211,238,0.7)]">
        ...
        <div className="grid min-h-[32rem] bg-[var(--app-background)] lg:grid-cols-[15rem_1fr]">
            ...
            <div className="mt-6 grid gap-4 lg:grid-cols-[0.95fr_1.05fr]">
              <section className="rounded-[var(--radius)] border border-white/[0.08] bg-white/[0.05] p-4">
                ...
                <button
                  type="button"
                  disabled
                  className="mt-5 inline-flex h-10 items-center justify-center rounded-[var(--radius)] border border-[var(--border)] px-3 text-sm text-[var(--muted)] opacity-70"
                >
                  Connect TikTok
                </button>
              </section>
